	...
	<div id="page">
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-7 col-md-9">
							<div id="colorlib-logo"><a href="http://localhost/fyp/user_home_page.php">4M Online Sports Shoe Store</a></div>
						</div>
		...
		<div class="breadcrumbs">
			<div class="container">
				<div class="row">
					<div class="col">
						<p class="bread"><span><a href="http://localhost/fyp/user_home_page.php">Home</a></span> / <span>Men</span></p>
					</div>
				</div>
			</div>
		</div>
...
<?php
$select_query = "SELECT * FROM product INNER JOIN product_details ON product.product_id = product_details.product_id WHERE product_gender='men'";
        ...
        foreach ($uniqueProducts as $product) { ?>
            <div class="col-md-4 col-lg-4 mb-4 text-center">
                <div class="product-entry border">
                    <a href="http://localhost/fyp/men_product_detail.php?product_id=<?php echo $product['product_id']; ?>" class="prod-img">
                        <?php
