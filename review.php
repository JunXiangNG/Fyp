...
?>	
	...
	<div id="page">
		...
		<div class="breadcrumbs">
			<div class="container">
				<div class="row">
					<div class="col">
						<p class="bread"><span><a href="user_home_page.php">Home</a></span> / <span>Review</span></p>
					</div>
				</div>
			</div>
		</div>
						...
						<div class="contact-wrap">
							...
							<div class="col-sm-12">
								...
								?>
									...
									<input type="text" name="name" id="fname" class="form-control" value="<?php echo $username; ?>" readonly>
								</div>
							</div>
									...
									<div class="col-sm-12">
										<div class="form-group">
											<label for="subject">Rating</label><br>
									...
									<div class="col-sm-12">
										<div class="form-group">
										<input type="submit" name="savebtn" value="Send Message" class="btn btn-primary">
  ...
  if(isset($_POST['savebtn'])) {
    ...
    $query = "INSERT INTO review (username, comment, rating) VALUES ('$name', '$message', '$rating')";
    mysqli_query($connect, $query);

    // Show success message using alert
    echo '<script>alert("Reviews successfully submitted!");</script>';
