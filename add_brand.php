    ...
    <script>
        ...
        for (var i = 0; i < files.length; i++) {
          ...
          reader.onload = function (e) {
            ...
            img.style.width = '188px'; // Adjust the width as needed
            img.style.height = '188px'; // Adjust the height as needed
                    ...
                    <li class="active">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="Blog Details" href="#"><span class="mini-sub-pro">Update Product</span></a></li>
                            </ul>
                        </li>
                        <li>
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                        ...
                                                        <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                            ...
                                                            <li><a href="add_admin.php"><span class="icon nalika-diamond author-log-ic"></span> Add Admin</a>
                                                            </li>
                                                            <li><a href="admin-login.php"><span class="icon nalika-unlocked author-log-ic"></span> Log Out</a>
                                                            </li>
                                                        </ul>
                                                </li>
                                            </ul>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i> Add Brand</a></li>
                                </ul>
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                        <div class="row">
                                        <form method="post" action="f_brand.php" enctype="multipart/form-data">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="review-content-section">
                                                        ...
                                                        <div class="input-group mg-b-pro-edt">
                                                            <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                            <input type="text" class="form-control" name="brand_code" placeholder="Brand Code" required>
                                                        </div>
                                                    </div>
                                                </div>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <div class="review-tab-pro-inner">
                          ...
                          <div id="myTabContent" class="tab-content custom-product-edit">
                              <div class="product-tab-list tab-pane fade active in" id="description">
                                  <div class="row">
                                  <form method="post" action="f_product.php" enctype="multipart/form-data">
                                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                          <div class="review-content-section">
                                                <p>Brand Name</p>
                                                    <div class="input-group mg-b-pro-edt">
