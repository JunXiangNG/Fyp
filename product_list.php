                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <table>
                                ...
                                $query = "SELECT p.product_id, p.product_name, p.product_description, b.brand_name, pd.product_color, pd.product_size, pd.product_quantity, pd.product_status, pd.product_image
                                            FROM product p
                                ...
                                if ($result && $result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        $productName = $row['brand_name'] . ' ' . $row['product_name'];
                                        ?>
                                        <tr>
                                            <td>
                                                <?php
                                                ...
                                                if ($imageData) {
                                                    echo '<img src="data:image/jpeg;base64,' . base64_encode($imageData) . '" style="max-width: 100px; max-height: 100px;" />';
                                                } else {
                                                    echo 'No Image';
                                                }
                                                ?>
